package teamr.hackerton18.samsung.fragmentex.solidityGenerated;
 ...
 */
public class HakathonDemo2018 extends Contract {
    ...
    protected HakathonDemo2018(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected HakathonDemo2018(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public static RemoteCall<HakathonDemo2018> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(HakathonDemo2018.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<HakathonDemo2018> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(HakathonDemo2018.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }

    public static HakathonDemo2018 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new HakathonDemo2018(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static HakathonDemo2018 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new HakathonDemo2018(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }
